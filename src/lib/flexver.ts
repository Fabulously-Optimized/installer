// flexver publishes a npm package but is neither CJS nor ESM so it's unusable that way
// as it's unlikely to change much, just vendor it directly inside
// all the warnings are disabled because this is external code
/* eslint-disable */
// @ts-nocheck
